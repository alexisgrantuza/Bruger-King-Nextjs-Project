          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-4">
              <div className="flex flex-col items-center text-center">
                <h1 className="text-4xl font-bold text-secondaryColor font-display">
                  Create an account
                </h1>
                <p className="text-balance text-muted-foreground font-display">
                  Sign up BurgerKing Account
                </p>
              </div>
              ...
              <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
                <span className="relative z-10 text-white bg-black font-display px-2 text-muted-foreground">
                  Or sign up with
                </span>
              </div>
